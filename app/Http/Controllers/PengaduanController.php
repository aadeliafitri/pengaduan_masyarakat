...
class PengaduanController extends Controller
{
    ...
    public function getAllPengaduan($limit = NULL, $offset = NULL)
    {
        if($this->user->level == 'masyarakat'){
            ...
            if($limit == NULL && $offset == NULL){
                ...
                ->orderBy('tgl_pengaduan', 'desc')->with('kategori','tanggapan','user')->get();
            } else {
                $data["pengaduan"] = Pengaduan::where('id_user', '=', $this->user->id)
                ->orderBy('tgl_pengaduan', 'desc')->with('kategori','tanggapan','user')->take($limit)->skip($offset)->get();
            }
        } else {
    ...
    {   
        $data["pengaduan"] = Pengaduan::where('id_pengaduan', $id)
        ->with(['kategori','tanggapan'])->get();
